...
![服务端系统里的 Agent Runtime](/images/agent-react-cover.png)
...
![图 1：ReAct 最小闭环](/images/agent-react-1.png)
...
![图 2：Agent 调工具的运行时结构](/images/agent-react-2.png)
...
![图 3：ReAct 与 Function Calling 的层级关系](/images/agent-react-3.png)
...
![图 4：从单 Agent 到多 Agent / Workflow 的演进路线](/images/agent-react-4.png)
...
![图 5：AgentOps 六层控制面](/images/agent-react-5.png)
...
![图 6：AgentOps 生命周期](/images/agent-react-6.png)
